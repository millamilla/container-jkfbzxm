...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-jkfbzxm.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-jkfbzxm.containers.anotherwebservice.com/
...
```
git clone git@github.com:millamilla/container-jkfbzxm.git
cd container-jkfbzxm
```
...
```
docker attach container-jkfbzxm
```
